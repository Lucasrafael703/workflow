...
# 44.1 Exemplo de grupo — Processos
...
- `processo.aplicar` permite utilizar um processo disponível em uma atividade;
- editar rascunho não significa poder alterar versão publicada;
- publicar é ação mais sensível e pode ser restrita;
- menu e botões respeitam autorização, mas a validação continua no backend e no banco.
